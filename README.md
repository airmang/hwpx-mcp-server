...
현재 저장소 기준 검증 버전은 `python-hwpx 2.10.1`입니다 (2026-06-04 검증).
최소 지원 버전은 `python-hwpx >= 2.10.1`입니다.
...
기본 모드에서 47개 HWPX 도구를 제공하며, 고급 모드(`HWPX_MCP_ADVANCED=1`)에서는 점검·검증용 도구까지 총 57개가 활성화됩니다.
