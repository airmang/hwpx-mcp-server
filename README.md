...
요구 사항: `Python >= 3.10` · `python-hwpx >= 3.0.0`
...
- 3.0.0 제품 경계 전환: [`docs/product-boundary-migration-3.0.0.md`](docs/product-boundary-migration-3.0.0.md)
- 3.0.0 기계 판독 계약 delta: [`docs/tool-contract-delta-3.0.0.json`](docs/tool-contract-delta-3.0.0.json)
