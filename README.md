...
현재 공개 릴리스는 `hwpx-mcp-server 4.1.0`이며 최소 호환 코어는
`python-hwpx 3.2.0`, 대응 스킬 최소 버전은 `0.4.0`입니다. 기본 121개·고급 모드
포함 132개 도구와 28개 skill-required 도구는 유지되며 계약 해시는
`c127914cc3f4480e`입니다.
...
요구 사항: `Python >= 3.10` · `python-hwpx >= 3.2.0`
...
- 4.1.0의 생성 계약: [`docs/tool-contract.generated.json`](docs/tool-contract.generated.json)
