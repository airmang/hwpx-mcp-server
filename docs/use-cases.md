...
> 않은 6.4.0 source candidate입니다. 현재 공개 트레인은
> `python-hwpx 5.3.0 → python-hwpx-automation 6.3.1 → hwpx-plugin 1.3.0`입니다.
...
이 문서는 아직 공개되지 않은 6.4.0 source candidate 기준입니다(후보 계약
해시 `dbdbdfaac26148b7`). 현재 공개 트레인은 `python-hwpx 5.3.0 →
python-hwpx-automation 6.3.1 → hwpx-plugin 1.3.0`, 공개 계약 해시는
`236f8ea855c875fe`입니다.

6.4.0 후보의 기본 모드 122개(고급 모드 포함 총 130개)의 도구로 문서 생성,
...
문서화·테스트 기준 upstream 버전 바닥은 `python-hwpx >= 5.4.0`입니다.
