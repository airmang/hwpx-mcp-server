...
이 문서는 아직 공개되지 않은 6.0.3 source candidate를 기준으로 합니다.
후보 좌표는 `python-hwpx 5.0.1 → python-hwpx-automation 6.0.3 →
...
6.0.3 후보의 기본 모드 119개(고급 모드 포함 총 127개)의 도구로 문서 생성,
