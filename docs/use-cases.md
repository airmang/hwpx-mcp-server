...
>
> 릴리스 상태: `released` (2026-08-02) — 현재 공개 트레인은
> `python-hwpx 5.5.0 → python-hwpx-automation 6.5.1 → hwpx-plugin 1.5.0`입니다.
...
이 문서는 공개 릴리스 `python-hwpx-automation 6.5.1` 기준입니다. 공개
트레인은 `python-hwpx 5.5.0 → python-hwpx-automation 6.5.1 →
hwpx-plugin 1.5.0`, 계약 해시는 `f61d2c60c0aa0413`입니다.

6.5.1 릴리스의 기본 모드 125개(고급 모드 포함 총 133개)의 도구로 문서 생성,
