...
이 문서는 공개 릴리스 `python-hwpx-automation 6.6.4` 기준입니다. 공개
트레인은 `python-hwpx 5.6.0 → python-hwpx-automation 6.6.4 →
hwpx-plugin 1.6.0`, 계약 해시는 `19898dba41495c47`입니다.

6.6.4 릴리스의 기본 모드 126개(고급 모드 포함 총 134개)의 도구로 문서 생성,
