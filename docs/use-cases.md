...
>
> 릴리스 상태: `unreleased-candidate` (2026-08-03) — 현재 공개 트레인은
...
이 문서는 **아직 공개되지 않은 6.7.1 source candidate** 기준입니다. 현재
공개 트레인은 여전히 `python-hwpx 5.6.0 → python-hwpx-automation 6.6.4 →
hwpx-plugin 1.6.0`(계약 해시 `19898dba41495c47`)이고, 이 후보의 계약 해시는
`98510af22d13899c`입니다.

6.7.1 후보의 기본 모드 128개(고급 모드 포함 총 136개)의 도구로 문서 생성,
