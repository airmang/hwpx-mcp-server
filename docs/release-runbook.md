...
2. canonical `python-hwpx-automation 6.0.3` and compatibility
   `hwpx-mcp-server 6.0.3` are observed on PyPI, and the automation GitHub
...
2. promote `currentPublic` to core 5.0.1, canonical automation 6.0.3, plugin
