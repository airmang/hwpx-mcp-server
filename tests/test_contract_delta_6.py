...
def test_6_6_3_contract_delta_is_additive_and_matches_the_live_contract() -> None:
    delta = _load("tool-contract-delta-6.6.3.json")
...
def test_6_5_1_delta_receipt_is_frozen_and_chains_into_the_6_6_3_baseline() -> None:
    """The historical 6.5.1 receipt stays frozen against its own hashes (not the
    live contract) and its target must be exactly the 6.6.3 baseline."""
