...
CLI::
    ...
    python -m hwpx_mcp_server.office.rendering.oracle \
    ...
    def render_many(self, pairs: list[tuple[str, str]]) -> dict[str, str | None]:
        ...
        try:
            ...
            with resources.as_file(
                resources.files("hwpx_mcp_server.office.rendering").joinpath(
                    _BACKEND_SCRIPT
                )
            ) as ps1:
                cmd = [
...
def _main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="python -m hwpx_mcp_server.office.rendering.oracle",
