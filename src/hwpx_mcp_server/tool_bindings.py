...
def _build_tool_bindings() -> Mapping[str, Callable[..., Any]]:
    candidates: dict[str, Callable[..., Any]] = {
        ...
        "plan_edit": content_edit.plan_edit,
        "preview_edit": content_edit.preview_edit,
        "apply_edit": content_edit.apply_edit,
        ...
        "analyze_quality_generation": form_fill.analyze_quality_generation,
        "apply_quality_generation": form_fill.apply_quality_generation,
