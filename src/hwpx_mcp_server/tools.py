    ...
    tools = [
        ...
        ToolDefinition(
            ...
            description=(
                ...
                "autofit_columns / set_row_heights / set_cell_line_spacing) to a form, PRESERVING the original table formatting "
                ...
                "cells wrapping a nested table are refused. Structure edits are grid-validated "
