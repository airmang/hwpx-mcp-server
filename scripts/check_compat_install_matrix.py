...
from importlib.metadata import distribution, version
from pathlib import Path
assert version("hwpx-mcp-server") == version("python-hwpx-automation") == "6.0.0"
import hwpx_automation
...
assert hwpx_mcp_server.__version__ == version("hwpx-mcp-server") == "6.0.0"
namespace = {}
exec("from hwpx_mcp_server import *", namespace)
assert namespace["__version__"] == "6.0.0"
